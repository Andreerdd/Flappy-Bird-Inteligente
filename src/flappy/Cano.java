...
public class Cano {
	...
	public void atualizar() {
		pos.x -= Flappy.app.deltaTime * VELOCIDADE_CANO;
...
//		Flappy.app.image(SpriteManager.get("pipe_body"), pos.x, pos.y - abertura / 2, largura, Flappy.app.height - pos.y - abertura / 2);
