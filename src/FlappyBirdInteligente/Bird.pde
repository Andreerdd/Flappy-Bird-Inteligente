...
class Bird {
    ...
    private final PVector POSICAO_INICIAL_PASSARO = new PVector(POSICAO_HORIZONTAL_PASSARO, height/2);
    ...
    void jump() {
        ...
        velocidade.y = velocidade.y > 0 ? -forcaPulo : velocidade.y - forcaPulo/2.6769;
    ...
    void update() {
        velocidade.add(GRAVIDADE.copy().mult(deltaTime));
    ...
    void draw() {
        ...
        rect(posicao.x, posicao.y - hitbox.y/2, hitbox.x, hitbox.y);
    }
}
